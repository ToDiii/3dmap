		...
		const res = await telemetryFetch('/api/model', {
			...
			body: JSON.stringify({
				...
				baseHeight: cfg.baseHeight,
                                ...
                                waterHeightMM: cfg.waterHeightMM,
                                greeneryHeightMM: cfg.greeneryHeightMM,
                                beachHeightMM: cfg.beachHeightMM,
                                pierHeightMM: cfg.pierHeightMM,
                                minWaterAreaM2: cfg.minWaterAreaM2,
                                footpathRoadsEnabled: cfg.footpathRoadsEnabled,
                                oceanEnabled: cfg.oceanEnabled,
                                beachEnabled: cfg.beachEnabled,
                                piersEnabled: cfg.piersEnabled,
                                elements,
